...
<div id="ajax_comments_wrapper">
                ...
                <li id="${comment.oId}">
                    <cite>
                        <img data-id="${comment.oId}" onclick="replyTo('${comment.oId}')" 
                             ...
                             src="${servePath}/skins/${skinDirName}/images/reply.png" 
                             alt="rebutton"
                             width="20"
                             height="16"
                             style="display: none;" />
    ...
    <ul class="endnotes">
        ...
        <li>${Endnotes5}</li>
        <li>${Endnotes6} <img src="${servePath}/skins/${skinDirName}/images/reply.png" width="20" height="16" alt="Reply" style="vertical-align:middle"> ${Endnotes7} <code style="padding:2px 5px">${Endnotes8}</code>.</li>
        <li>${Endnotes9}</li>
    </ul>
</div>
</#macro>
