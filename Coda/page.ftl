								...
								<ul class="postmeta opaque_5">
									...
									<li><a href="#" class="subscribe icon"> ${RSS}</a>
										<ul class="opaque_10 subscribe_to">
											...
											<li><a target="_blank" rel="nofollow" title="${RSSToXianGuo}" href="http://www.xianguo.com/subscribe.php?url=http://${blogHost}/blog-articles-feed.do" class="icon me_xianguo">${XianGuo}</a></li>
