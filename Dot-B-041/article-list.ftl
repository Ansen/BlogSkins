...
<#if 0 != paginationPageCount>
	...
	<ul class="page-numbers">
            ...
            <li><a href="/" title="${nextPagePabel}">${firstPageLabel}</a>
            <a href="${path}/${paginationPreviousPageNum}" title="${previousPageLabel}"><<</a></li>
            </#if>
            ...
            <li><a href="${path}/${paginationNextPageNum}" title="${nextPagePabel}">>></a>
            <a href="${path}/${paginationPageCount}" title="${lastPageLabel}">${lastPageLabel}</a></li>
            </#if>
